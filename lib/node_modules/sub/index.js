...
{
    {
        const main = (new DOMParser).parseFromString(body, 'text/html').getElementsByClassName('cool-work-main');
        console.log(main);
        ...
        const main = (new DOMParser).parseFromString(body, 'text/html').title;
        mainViewer.title.innerHTML = main;
    } {
        const main = (new DOMParser).parseFromString(body, 'text/html').getElementsByClassName('tags-container');
        console.log(main);
        mainViewer.tags.innerHTML = main[0].innerHTML;
    } {
        const main = (new DOMParser).parseFromString(body, 'text/html').getElementsByClassName('comment-list');
        console.log(main);
